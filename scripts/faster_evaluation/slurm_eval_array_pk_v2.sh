...
#SBATCH --job-name=vq2d_val_trace
...
#SBATCH --constraint "p40|rtx6k|rtx8k|a40"
#SBATCH --mem=56GB
...
EVAL_ROOT=$TRAIN_ROOT/results/traces_v2
...
python evaluate_vq2d_no_tracker_pk2_trace_v2.py \
