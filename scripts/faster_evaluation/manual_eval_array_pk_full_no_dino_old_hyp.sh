...
#SBATCH --job-name=vq2d_val_full_no_dino_old_hyp
#SBATCH --output=/scratch/shared/beegfs/prannay/ego4d_data/logs/slurm_eval/eval_vq2d-%j.out
...
#SBATCH --constraint="a40|v100s|rtx6k|rtx8k|a4500|a6000"
...
EVAL_ROOT=$TRAIN_ROOT/full_run/original_old_hyp
...
for i in $(seq $start $end); do
  CUDA_VISIBLE_DEVICES=${device} python evaluate_vq2d_tracker_pk2_trace_v2_all.py \
    ...
    logging.stats_save_path="$EVAL_ROOT/vq_stats_val_${i}.json.gz" \
