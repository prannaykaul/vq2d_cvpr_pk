...
#SBATCH --job-name=vq2d_val_trace_v2_all
...
#SBATCH --constraint "p40|rtx6k|rtx8k|a40|v100s|a4500"
#SBATCH --mem=56GB
...
EVAL_ROOT=$TRAIN_ROOT/results/traces_v2_all
...
python evaluate_vq2d_no_tracker_pk2_trace_v2_all.py \
