...
#SBATCH --job-name=vq2d_val_full_dino_old_hyp
#SBATCH --output=/scratch/shared/beegfs/prannay/ego4d_data/logs/slurm_eval_new/eval_vq2d-%j.out
#####ASBATCH --error=/scratch/shared/beegfs/prannay/ego4d_data/logs/slurm_eval_new/eval_vq2d-%j.err
...
#SBATCH --mem=196GB
#SBATCH --constraint="a40|rtx6k|a6000|p40"
...
EVAL_ROOT=$TRAIN_ROOT/full_run/dino_rerank_old_hyp
